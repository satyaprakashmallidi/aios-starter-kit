...
Usage:
    python scripts/intel/collect_fathom.py              # Last 7 days
    python scripts/intel/collect_fathom.py --days 30    # Last 30 days
"""
...
def collect(days: int = 7) -> list[dict]:
    ...
    while True:
        ...
        if isinstance(data, list):
            ...
            # Fathom returns 'items' with pagination via 'next_cursor'
            meetings_data.extend(data.get("items", data.get("meetings", data.get("data", []))))
